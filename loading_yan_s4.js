...
function displayImages() {
    ...
    imagesContainer.innerHTML = `
        <div class="image-wrapper">
            ...
            <img src="1224_Yan/Yan_ccsn_paramSet1224_sankeyPlot.png" alt="First Image" class="image-size1">
            <a href="1224_Yan/Yan_ccsn_paramSet1224_sankeyPlot.png" download="Yan_ccsn_paramSet1224_sankeyPlot.png" class="download-button">
...
function createAndShowButton() {
    ...
    button.id = 'myButton';
    button.textContent = 'Back to Yan Analysis';
    ...
    button.addEventListener('click', function() {
        window.location.href = 'yan_analysis.php';
    });
}
