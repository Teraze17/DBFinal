...
function displayImages() {
    ...
    imagesContainer.innerHTML = `
        <div class="image-wrapper">
            ...
            <img src="1224_Kim/Kim_ccsn_scatter_true_paramSet1224.png" alt="First Image" class="image-size1">
            <a href="1224_Kim/Kim_ccsn_scatter_true_paramSet1224.png" download="Kim_ccsn_scatter_true_paramSet1224.png" class="download-button">
...
function createAndShowBackButton() {
    ...
    backButton.addEventListener('click', function() {
        window.location.href = 'kim_step1_Analysis.php';
    });
}
