...
function displayImages() {
    ...
    imagesContainer.innerHTML = `
        ...
        <img src="1224_Kim/Kim_ccsn_scatter_pred_paramSet1224.png" alt="First Image" class="image-size1">
        <a href="1224_Kim/Kim_ccsn_scatter_pred_paramSet1224.png" download="Kim_ccsn_scatter_pred_paramSet1224.png" class="download-button">
...
function createAndShowButton() {
    ...
    button.addEventListener('click', function() {
        window.location.href = 'kim_step4_Analysis.php';
    });
}
