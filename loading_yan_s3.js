...
function displayImages() {
    ...
    imagesContainer.innerHTML = `
        <div class="image-wrapper">
            <h2>Cluster based on Network</h2> <!-- Title for the first image -->
            <img src="1224_Yan/Yan_ccsn_scatter_pred_paramSet1224.png" alt="First Image" class="image-size1">
            <a href="1224_Yan/Yan_ccsn_scatter_pred_paramSet1224.png" download="Yan_ccsn_scatter_pred_paramSet1224.png" class="download-button">
...
function createAndShowButton() {
    ...
    button.id = 'myButton';
    button.textContent = '>> Step 4 Sankey Plot';
    ...
    button.addEventListener('click', function() {
        window.location.href = 'yan_step4_Analysis.php';
    });
}
