...
<body>
    ...
    <div class="analysis-buttons">
        ...
        <button type="button" onclick="location.href='yan_step3_Analysis.php';">Step 2 Cluster based on Network</button>
        <button type="button" onclick="location.href='yan_step4_Analysis.php';">Step 3 Sankey Plot</button>
    </div>
